...
ShowcaseDataEntry
key (Rkey,
value (2.PBAntiqueShowcaseDataRvalue:8"ƒ
...
state	 (Rstate1
auction_data
 (2.PBAuctionDataRauctionData"î
PBAuctionLogData
log_id (RlogId
...
error (	Rerror
uid (Ruid>
self_auction_info (2.PBSelfAuctionDataRselfAuctionInfo"Ö
...
custom_condition2	 (RcustomCondition2
	sort_type
 (RsortType
	start_idx (RstartIdx"û
PBSearchAuctionProductRspCmd
code (Rcode
error (	Rerror
uid (RuidB
search_products (2.PBAuctionProductBaseDataRsearchProducts"À
PBAuctionSaleReqCmd
uid (Ruid
	config_id (RconfigId
uniqid (Runiqid
...
uniqid (Runiqid
pos (Rpos.
price_change_result (RpriceChangeResult"‚
PBAntiqueShowReqCmd
	config_id (RconfigId
uniqid (Runiqid
showcase_id (R
...
uid (Ruid
roleid (Rroleid5
need_repairs (2.PBRepairEquipmentRneedRepairs"Æ
...
grade_data (2.PBGradeDataR	gradeData"Ñ
PBGradeShowData
grade_id (RgradeId&
now_grade_score (RnowGradeScore.
...
buy_id_num (2.PBShopSelectBuyRbuyIdNum"õ
PBShopBuyRspCmd
code (Rcode
error (	Rerror
uid (Ruid
...
buy_id_num (2.PBShopSelectBuyRbuyIdNum"Ê
PBTreasureSingle
	config_id (RconfigId
...
uid (Ruid*
battle_report_ids (RbattleReportIds"à
...
test_bag (2.PBBagRtestBag(
	test_item (2.PBItemDataRtestItem"à
PBTestBagRspCmd
code (Rcode
error (	Rerror!
test_bag (2.PBBagRtestBag(
...
cond_datas (2.PBConditionDataR	condDatas"™
PBLinearMissionInfo"
...
uid (Ruid$
unlock_pass_id (RunlockPassId"ì
PBUnlockSeasonPassRspCmd
code (Rcode
error (	Rerror
uid (Ruid;
season_pass_data (2.PBSeasonPassDataRseasonPassData"Ö
PBGetSeasonPassRewardReqCmd
uid (Ruid
pass_id (RpassId
cur_page_id (R	curPageId
	reward_id (RrewardId"ñ
...
price (Rprice
now_num (RnowNum+
skin_trade_id_list (RskinTradeIdList"Ø
...
PriceToNumEntry
key (Rkey(
value (2.PBSkinPriceAndNumRvalue:8"Ω
PBSelfSkinTradeInfo!
box_capacity (RboxCapacity$
can_onsale_cnt (RcanOnsaleCnt
	update_ts (RupdateTs$
...
error (	Rerror
uid (Ruid"
skin_trade_id (RskinTradeId"Ç
PBSkinTradeBuyReqCmd
uid (Ruid
	config_id (RconfigId
buy_num (RbuyNum"
buy_max_price (RbuyMaxPrice"ì
...
key (Rkey&
value (2.PBSkinBuySingleRvalue:8"à
...
trade_data (2.PBTradeDataR	tradeData"™
PBTradeLogData
log_id (RlogId
trade_id (RtradeId
	config_id (RconfigId
...
key (Rkey"
value (2.PBBuySingleRvalue:8"Ä
