...
---@field public award_target6 integer @活跃度目标值6
---@field public award6 table @奖励配置6
---@field public award_target7 integer @活跃度目标值7
---@field public award7 table @奖励配置7
---@field public award_target8 integer @活跃度目标值8
---@field public award8 table @奖励配置8
---@field public award_target9 integer @活跃度目标值9
---@field public award9 table @奖励配置9
