---@class BaGuaBrand_cfg
---@field public id integer @不同品质八卦牌的信息 1.白 2.蓝 3.紫 4.金 5.红
---@field public maxlv integer @最大等级
---@field public tagnum integer @最大词条数量
---@field public tagcost1 table @第1次开光消耗
---@field public tagcost2 table @第2次开光消耗
---@field public tagcost3 table @第3次开光消耗
---@field public tagcost4 table @第4次开光消耗
---@field public tagcost5 table @第5次开光消耗
---@field public tagcost6 table @第6次开光消耗
---@field public tagcost7 table @第7次开光消耗
---@field public tagcost8 table @第8次开光消耗
