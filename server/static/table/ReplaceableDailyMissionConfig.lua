---@class ReplaceableDailyMissionConfig_cfg
---@field public id integer @任务 id
---@field public type integer @用于给任务的UI （非功能分类）
...
return {
[1] = { id=1,type=0,unlock_level=1,front_mission={},target1=1,target1_data=10,target1_param1=0,target1_param2=0,target1_arr={},target2=3,target2_data=10,target2_param1=0,target2_param2=0,target2_arr={},start_time=0,end_time=0,rewards={[1]=1},vitality=0 },
[2] = { id=2,type=0,unlock_level=1,front_mission={},target1=2,target1_data=10,target1_param1=0,target1_param2=0,target1_arr={},target2=4,target2_data=10,target2_param1=0,target2_param2=0,target2_arr={},start_time=0,end_time=0,rewards={[1]=1},vitality=0 }
}