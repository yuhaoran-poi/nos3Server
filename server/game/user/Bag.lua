...
function Bag.PBAntiqueIdentifyReqCmd(req)
    moon.info(string.format("PBAntiqueIdentifyReqCmd - uid = %s, config_id = %d, uniqid = %s, pos = %d", tostring(req.msg.uid), req.msg.config_id, tostring(req.msg.uniqid), req.msg.pos))
